...
def json_to_md(filename, md_filename,
    ...
    with open(md_filename, "a+") as f:
        ...
        if show_badge == True: # 没用上
            # unk
            f.write(
                f"[contributors-shield]: https://img.shields.io/github/contributors/bansky-cl/tods-arxiv-daily-paper.svg?style=for-the-badge\n")
            f.write(f"[contributors-url]: https://github.com/bansky-cl/tods-arxiv-daily-paper/graphs/contributors\n")
            f.write(
                f"[forks-shield]: https://img.shields.io/github/forks/bansky-cl/tods-arxiv-daily-paper.svg?style=for-the-badge\n")
            f.write(f"[forks-url]: https://github.com/bansky-cl/tods-arxiv-daily-paper/network/members\n")
            f.write(
                f"[stars-shield]: https://img.shields.io/github/stars/bansky-cl/tods-arxiv-daily-paper.svg?style=for-the-badge\n")
            f.write(f"[stars-url]: https://github.com/bansky-cl/tods-arxiv-daily-paper/stargazers\n")
            f.write(
                f"[issues-shield]: https://img.shields.io/github/issues/bansky-cl/tods-arxiv-daily-paper.svg?style=for-the-badge\n")
            f.write(f"[issues-url]: https://github.com/bansky-cl/tods-arxiv-daily-paper/issues\n\n")
